...
## نسخه عمومی بدون سرور

[نسخه نمایشی آنلاین](https://moroshani.github.io/setadinfo/) از public `main`
منتشر می‌شود و همه داده‌ها و mutationها را داخل مرورگر نگه می‌دارد. این نسخه
هیچ درخواست `/api`، Setad یا Rubika ندارد و به اطلاعات production دسترسی ندارد.

شاخه release candidate در 2026-08-09 نسخه نمایشی public را با قرارداد جدید
پایش، کارت اعلان و پیش‌نمایش پیام ادغام کرده است. دستور `pnpm verify:demo`
build استاتیک را می‌سازد و نبود درخواست شبکه حساس را بررسی می‌کند.

## داده نمونه full-stack برای بازبینی محصول
