...
describe('ConfirmDialog', () => {
  it('renders title, description, and default buttons', async () => {
    ...
    await expect
      ...
      .toBeInTheDocument()
    await expect
      .element(getByRole('button', { name: 'انصراف' }))
      .toBeInTheDocument()
    await expect
      .element(getByRole('button', { name: 'ادامه' }))
      .toBeInTheDocument()
  })
  ...
  it('disables confirm when disabled is true', async () => {
    ...
    const confirm = getByRole('button', { name: 'ادامه' })
  ...
  it('when isLoading is true, disables cancel and confirm', async () => {
    ...
    await expect.element(getByRole('button', { name: 'انصراف' })).toBeDisabled()
    await expect.element(getByRole('button', { name: 'ادامه' })).toBeDisabled()
  })
